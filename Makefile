...
# Rules
all: prueba_create create_write_close open_read_close openat_read_close fopen_fread_fclose create_fwrite_fclose fopen_fread_fclose
...
clean:
	rm -f ./*.o
	rm -f ./prueba_create ./create_write_close ./open_read_close ./openat_read_close ./fopen_fread_fclose ./create_fwrite_fclose ./fopen_fread_fclose