...
# Rules
all: prueba_create create_write_close open_read_close openat_read_close fopen_read_close
...
fopen_read_close: fopen_read_close.o
	$(CC) -o fopen_read_close fopen_read_close.o $(MYLIBPATH) $(LIBRARIES)
...
clean:
	rm -f ./*.o
	rm -f ./prueba_create ./create_write_close ./open_read_close ./openat_read_close ./fopen_read_close